...
**Version incluse :** 0.17.0~ynh1 *(:warning: Il s'agit de la branche `dev`. La [branche `master`](https://github.com/YunoHost-Apps/pyinventory_ynh/tree/master) utilisée dans le catalogue est actuellement en 0.16.0\~ynh2.)*
